        ...
        <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-12 col-md-5 mb-4">
                    <img src="/images/placeholder.png" alt="Image" class="img-fluid rounded mt-2 mb-3" id="item-image">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('obtained') is-invalid @enderror" type="date"
                                    name="obtained" id="obtained" value="{{ old('obtained') }}">
                                @error('obtained')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                @forelse ($labels as $label)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="labels[]"
                                            value="{{ $label->id }}" @checked(in_array($label->id, old('labels', [])))>
